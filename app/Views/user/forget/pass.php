...
const PAGE_NAME = 'メール認証 | パスワード忘れ変更';
...
<form id="form1" method="post" action="/user/forget_pass_mailauth">
...
<dd>
    <div class="ec-input">
        <input type="text" name="mail_address" value="" placeholder="name@domain.jp">
    </div>
</dd>
</dl><!-- －－－－－－－－－－－－－－－－－－－－－ -->
