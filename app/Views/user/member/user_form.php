...
<form id="form1" method="post" action="/user/user_confirm">
...
<dd>
	<div class="ec-input">
		...
		<input name="zipcode" type="text" class="p-postal-code digit-8" size="8" maxlength="8" value="<?= htmlspecialchars($zipcode ?? '', ENT_QUOTES) ?>" placeholder="1234567" style="display:inline-block"> 郵便番号をご入力ください<br>
